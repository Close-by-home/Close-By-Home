insert
    ...
    ('70655803','29.000.670/0001-90','02525000','eduardo@gmail.com',2,10,'Eduardo','11979564553','11969385228');
...
insert
    into
        agenda
        (data,nota_servico,status,fk_codigo_funcionario,fk_id_funcionario)
    values
